...
var Game = function () {
	function Game(element, width, height) {
		...
		this.paddleWidth = 8, this.paddleHeight = 56, this.padding = 10;
		...
		this.ball = new _Ball2.default(this.width, this.height, this.radius = 8);

		this.ball2 = new _Ball2.default(this.width, this.height, this.radius = 8);
		...
		this.winner = new _Win2.default(this.width / 4, this.height / 2);
	}
...
var Board = function () {
  ...
  _createClass(Board, [{
    ...
    value: function render(svg) {
      ...
      line.setAttributeNS(null, 'stroke', '#BC331C');
...
var Paddle = function () {
  ...
  _createClass(Paddle, [{
    ...
    value: function render(svg) {
      ...
      rect2.setAttributeNS(null, 'fill', '#253C82');
